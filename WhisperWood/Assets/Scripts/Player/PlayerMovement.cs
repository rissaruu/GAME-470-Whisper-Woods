...
public class PlayerMovement : MonoBehaviour, IDataPersistence
{
    ...
    //[SerializeField] private TMP_Text vaultingText;
    public SafePuzzle safePuzzle;
    public Keypad keypad;
    private bool toldPlayerPrompt;
    ...
    void Start()
    {
        ...
        //vaultingText.gameObject.SetActive(false);
    }
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        else if (GameManager.isPlayer.jumping && collision.collider.CompareTag("Vault"))
        {
            ...
            //{
            //    if (!safePuzzle.reachedSafe && keypad.codeSolved)
            //    {
            //        vaultingText.gameObject.SetActive(true);
            //        toldPlayerPrompt = true;
